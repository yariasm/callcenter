            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form id="insert_result" action="<?php echo base_url('index.php/result/insert'); ?>" method="post" class="form-horizontal form-row-seperated">
                            <div class="form-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="codigo" value="<?php echo set_value('codigo') ?>" id="codigo" placeholder="Codigo" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nombre" value="<?php echo set_value('nombre') ?>" id="nombre" placeholder="Nombre" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <input type="hidden" name="total_causes" id="total_causes" value="0">
