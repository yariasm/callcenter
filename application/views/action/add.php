    ...
    <div class="page-content">
        ...
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo base_url('index.php/action/add') ?>">
                        Agregar
                    </a>
                </li>                 
            </ul>            
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet box blue">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form id="insert_action" action="<?php echo base_url('index.php/action/insert'); ?>" method="post" class="form-horizontal form-row-seperated">
                            <div class="form-body">
