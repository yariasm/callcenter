            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet box green">
                    ...
                    <div class="portlet-body">
                        ...
                        <a href="<?php echo base_url('index.php/action/add') ?>" class="btn blue">
                                    ...
                                    foreach ($registros as $registro) {
                                        ...
                                        <tr <?php echo ($registro->estado == 0) ? 'class="danger"' : '' ?>>
                                            ...
                                            <td style="font-size: 10px;">
                                                <?php echo $registro->accionresultado; ?>
                                            </td>                                             
                                            <td>
                                                <a href="<?php echo base_url('index.php/action/edit/'.encrypt_id($registro->accion_id)) ?>" class="btn default btn-xs purple">
