            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet box purple">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form id="update_cause" action="<?php echo base_url('index.php/cause/update/' . encrypt_id($registro[0]->causal_id)); ?>" method="post" class="form-horizontal form-row-seperated">
                            <div class="form-body">
