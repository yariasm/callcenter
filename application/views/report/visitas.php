...
<div class="page-content-wrapper">
    <div class="page-content">
        <!-- BEGIN PAGE HEADER-->
        <h3 class="page-title">
            Reportes del Sistema<small> - Generar Archivo Excel con Visitas</small>
        </h3>
        <div class="page-bar">
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-gift"></i>Reporte de Visitas
                        </div>
                        <div class="tools">
                    ...
                    <div class="portlet-body form">
                        <!-- BEGIN FORM-->
                        <form id="insert_portafolio" enctype="multipart/form-data" action="<?php echo base_url('index.php/report/get_visitas'); ?>" method="post" class="form-horizontal form-row-seperated">
                            <div class="form-body">
